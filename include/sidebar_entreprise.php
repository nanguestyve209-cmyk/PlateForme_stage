<div class=" sidebar">
    ...
    <ul class="list-unstyled mx-2 py-5">
        ...
        <li class="list-unstyled my-4"><i class="fa-solid fa-user-graduate mx-2"></i><a href="" class="text-white text-decoration-none">Profil de l'entreprise</a></li>
        <li class="list-unstyled my-4"><i class="fa-solid fa-building mx-2"></i><a href="" class="text-white text-decoration-none">Mes offres</a></li>
        ...
        <li class="list-unstyled my-4"><i class="fa-solid fa-briefcase mx-2"></i><a href="" class="text-white text-decoration-none">Candidatures</a></li>
        <li class="list-unstyled my-4"><i class="fa-solid fa-table-list mx-2"></i><a href="" class="text-white text-decoration-none">Notifications</a></li>
