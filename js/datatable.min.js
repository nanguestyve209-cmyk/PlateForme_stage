 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/dt-2.3.8
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.8
 */
...
((n) => {
  ...
  var C,
          ...
          : ((k = void 0 === (P = e)),
            ...
            this.each(function () {
              ...
              if ("table" != this.nodeName.toLowerCase())
                ...
                (t.on && t.on.options && st(a, "options", t.on.options),
                  a.trigger("options.dt", t),
                  K(r),
                  ee(r.column),
                  B(r, r, !0),
                  B(r.column, r.column, !0),
                  B(r, H.extend(t, ut(a.data())), !0));
                var o = V.settings;
                for (e = 0, j = o.length; e < j; e++) {
                  ...
                  if (
                    ...
                    var l = (void 0 !== t.bRetrieve ? t : r).bRetrieve,
                      s = (void 0 !== t.bDestroy ? t : r).bDestroy;
                ...
                if (t.aoColumns) h = t.aoColumns;
                  ...
                  for (j = n[(e = 0)].length; e < j; e++) h.push(null);
                for (e = 0, j = h.length; e < j; e++) te(c);
                var g,
                  m,
                  v,
                  b,
                ...
                if (T)
                  for (g = 0, m = T.length; g < m; g++)
                    T[g] && T[g].name && (I[g].sName = T[g].name);
                if (w)
                    ...
                    var A =
                      void 0 !== (x = w[g]).target
                        ...
                        : void 0 !== x.targets
                          ...
                          : x.aTargets;
                    for (
                      Array.isArray(A) || (A = [A]), v = 0, b = A.length;
                      v < b;
                      v++
                    ) {
                      var L = A[v];
                      if ("number" == typeof L && 0 <= L) {
                        for (; I.length <= L; ) te(S);
                        C(L, x);
                      } else if ("number" == typeof L && L < 0)
                        C(I.length + L, x);
                      else if ("string" == typeof L)
                        for (y = 0, D = I.length; y < D; y++)
                          "_all" === L
                            ? C(y, x)
                            : -1 !== L.indexOf(":name")
                              ? I[y].sName === L.replace(":name", "") && C(y, x)
                ...
                if (T) for (g = 0, m = T.length; g < m; g++) C(g, T[g]);
                var N,
                  n = a.children("tbody").find("tr:first-child").eq(0),
                  F =
                    (n.length &&
                      ((N = function (e, t) {
                    ...
                    Y(c, "aoDrawCallback", et),
                    c.oFeatures);
                if (
                  (t.bStateSave && (F.bStateSave = !0), void 0 === t.aaSorting)
                )
                  for (var O = c.aaSorting, e = 0, j = O.length; e < j; e++)
                    O[e][1] = c.aoColumns[e].asSorting[0];
                (Ke(c),
                  Y(c, "aoDrawCallback", function () {
                    (c.bSorted || "ssp" === G(c) || F.bDeferRender) && Ke(c);
                  }));
                var n = a.children("caption"),
                  n =
                    (c.caption &&
                      (n =
                        0 === n.length ? H("<caption/>").prependTo(a) : n).html(
                        c.caption,
                      ),
                    n.length &&
                      ...
                      (c.captionNode = n[0])),
                    n.length
                      ? c.colgroup.insertAfter(n)
                      : c.colgroup.prependTo(c.nTable),
                ...
                (H.extend(!0, R, t.oLanguage),
                  R.sUrl
                    ? H.ajax({
                        ...
                        error: function () {
                          (z(c, 0, "i18n file loading error", 21), We(c));
                        },
                      })
                    : (Z(c, null, "i18n", [c], !0), We(c)));
              }
            }),
            (E = null),
            this);
    ...
    J = function (e, t) {
      if (Array.isArray(t)) for (var n = 0; n < t.length; n++) J(e, t[n]);
      else e.push(t);
      return e;
    };
  function y(t, e) {
  ...
  V.util = {
            ...
            : "string" != typeof r ||
              ...
              : ((f = function (e, t, n) {
                  for (
                    ...
                    if (((r = l[s].match(ge)), (a = l[s].match(p)), r)) {
                      if (
                        ((l[s] = l[s].replace(ge, "")),
                        (e[l[s]] = []),
          ...
          : "function" == typeof a
            ...
            : "string" != typeof a ||
              ...
              : ((f = function (e, t, n) {
                  var r, a, o;
                  if ("" !== n)
                    for (var i = me(n), l = 0, s = i.length; l < s; l++) {
                      if (((d = i[l].match(ge)), (r = i[l].match(p)), d)) {
                        if (
                          ((i[l] = i[l].replace(ge, "")),
                          "" !== i[l] && (e = e[i[l]]),
                          (a = []),
    ...
    stripHtml: function (e, t) {
      var n = typeof e;
      if ("function" != n) return "string" == n ? I(e, t) : e;
      I = e;
    },
    ...
    (a(e, "ordering", "bSort"),
      ...
      "object" == typeof e.bSort
        ? ((e.orderIndicators =
          ...
          (e.orderHandler = void 0 === e.bSort.handler || e.bSort.handler),
          (e.bSort = !0))
        : !1 === e.bSort
          ? ((e.orderIndicators = !1), (e.orderHandler = !1))
          : !0 === e.bSort && ((e.orderIndicators = !0), (e.orderHandler = !0)),
      "boolean" == typeof e.bSortCellsTop && (e.titleRow = e.bSortCellsTop));
  ...
  function re(e) {
    ((t) => {
      if (t.oFeatures.bAutoWidth) {
        var e,
          ...
          f = a.style.width,
          h = $e(t);
        if (h === t.containerWidth) return;
        ((t.containerWidth = h),
          f || c || ((a.style.width = "100%"), (f = "100%")),
          f && -1 !== f.indexOf("%") && (c = f),
          Z(t, null, "column-calc", { visible: u }, !1));
        var p = H(a.cloneNode())
          ...
          g =
            (p.append("<tbody/>"),
            p.append(H(t.nTHead).clone()).append(H(t.nTFoot).clone()),
            p.find("tfoot th, tfoot td").css("width", ""),
            p.find("thead th, thead td").each(function () {
              var e = de(t, this, !0, !1);
              e
                ? ((this.style.width = e),
                  s &&
        ...
        for (e = 0; e < u.length; e++)
          g.push(
            ((e, t) => {
              ...
              if (!n.wideStrings) {
                for (
                  var r = [], a = [], o = 0, i = e.aiDisplayMaster.length;
                  o < i;
                  o++
                ) {
                  var l = e.aiDisplayMaster[o],
                    l = xe(e, l)[t],
                    l =
                      l && "object" == typeof l && l.nodeType
                        ? l.innerHTML
                        : l + "",
                    s =
                      ((l = (l = l
                      ...
                      I(l, " ").replace(/&nbsp;/g, " "));
                  (a.push({ str: l, len: s.length }), r.push(s));
                }
                (a
                  .sort(function (e, t) {
                    return t.len - e.len;
                  ...
                  .splice(3),
                  (n.wideStrings = a.map(function (e) {
                    return e.str;
                  })));
                var u = r.join(" ").split(" ");
                (u.sort(function (e, t) {
                  ...
                  u.length && n.wideStrings.push(u[0]),
                  1 < u.length && n.wideStrings.push(u[1]),
                  2 < u.length && n.wideStrings.push(u[3]));
              }
              return n.wideStrings;
            })(t, u[e]),
          );
        if (g.length)
          for (e = 0; e < g[0].length; e++) {
            var m = H("<tr/>").appendTo(p.find("tbody"));
            for (n = 0; n < u.length; n++) {
              ((r = u[n]), (r = o[r]));
              var v = g[n][e] || "",
                b = C.type.className[r.sType],
                y = v + (r.sContentPadding || (s ? "-" : "")),
                v =
                  -1 === v.indexOf("<") && -1 === v.indexOf("&")
                    ? _.createTextNode(y)
                    : y;
              H("<td/>").addClass(b).addClass(r.sClass).append(v).appendTo(m);
            }
          }
        H("[name]", p).removeAttr("name");
        var D,
          x,
          h = H("<div/>")
            .css(
            ...
            (s && i
              ...
              : s
                ...
                : l
                  ...
                  : c && p.outerWidth(c),
            0),
          w = p.find("tbody tr").eq(0).children();
        for (e = 0; e < u.length; e++) {
          var T = w[e].getBoundingClientRect().width;
          ((S += T), (o[u[e]].sWidth = A(T)));
        }
        ((a.style.width = A(S)),
          h.remove(),
          c && (a.style.width = A(c)),
          (!c && !s) ||
            t._reszEvt ||
            ((D = V.util.throttle(function () {
              var e = $e(t);
              t.bDestroying || 0 === e || re(t);
            })),
            W.ResizeObserver
              ? ((x = H(t.nTableWrapper).is(":visible")),
                (f = H("<div>")
                ...
                t.resizeObserver.observe(f[0]))
              : H(W).on("resize.DT-" + t.sInstance, D),
            (t._reszEvt = !0)));
      }
    })(e);
    ...
    var o = e.oScroll;
    (("" === o.sY && "" === o.sX) || ze(e), Z(e, null, "column-sizing", [e]));
  }
  function ae(e, t) {
    e = le(e, "bVisible");
  ...
  function ue(e) {
    for (
          ...
          for (r = 0, a = s.length; r < a; r++)
            if (s[r]) {
              if (
                ...
                h && !m && (m = se(f, h(i[r], e))),
                !(v = se(f, p(i[r], e))) && t !== u.length - 3)
              )
                break;
              if ("html" === v && !T(i[r])) break;
            }
          if ((h && m && v) || (!h && v)) {
            o.sType = v;
            break;
      ...
      var b = C.type.className[o.sType],
        b =
          (b && (ce(e.aoHeader, c, b), ce(e.aoFooter, c, b)),
  ...
  function D(e, t, n, r) {
    ...
    return (
      void 0 !== t && (e.aIds[t] = o),
      (!n && e.oFeatures.bDeferRender) || Se(e, a, n, r),
      a
    );
  }
  function he(n, e) {
    ...
    return (e = e instanceof H ? e : H(e)).map(function (e, t) {
      return ((r = De(n, t)), D(n, r.data, t, r.cells));
    });
  }
  function q(e, t, n, r) {
  ...
  function ye(e, t, n, r) {
    ...
    if (
      ...
      var l = i.anCells,
        s = xe(e, t);
      if (l)
        if (void 0 !== r) pe(l[r], s[r]);
        else for (a = 0, o = l.length; a < o; a++) pe(l[a], s[a]);
    } else i._aData = De(e, i, r, void 0 === r ? void 0 : i._aData).data;
    var u = e.aoColumns;
    if (void 0 !== r) ((u[r].sType = null), (u[r].wideStrings = null));
    else {
      for (a = 0, o = u.length; a < o; a++)
        ((u[a].sType = null), (u[a].wideStrings = null));
      we(e, i);
    }
  }
  function De(e, t, n, r) {
  ...
  function Se(e, t, n, r) {
    ...
    if (null === c.nTr) {
      for (
        ...
        ((i = e.aoColumns[l]),
          (o = (u = !n || !r[l]) ? _.createElement(i.sCellType) : r[l]) ||
      ...
      Z(e, "aoRowCreatedCallback", "row-created", [a, d, t, f]);
    } else y(c.nTr, h);
  }
  function we(e, t) {
    var n = t.nTr,
    ...
    n &&
      ...
      r.DT_RowClass &&
        ...
        (t.__rowc = t.__rowc ? w(t.__rowc.concat(e)) : e),
  ...
  function Ce(e, t) {
    for (var n, r, a = _e(e, t), o = 0; o < t.length; o++) {
  ...
  function x(e, t) {
    if (
      ...
      -1 !== Z(e, "aoPreDrawCallback", "preDraw", [e]).indexOf(!1))
    )
      S(e, !1);
    else {
      var l,
      ...
      if (((e.bDrawing = !0), e.deferLoading))
        ((e.deferLoading = !1), e.iDraw++, S(e, !1));
      else if (a) {
        if (!e.bDestroying && !t)
          return (
            0 === e.iDraw && c.empty().append(Ae(e)),
            (l = e).iDraw++,
            S(l, !0),
            void Oe(
              l,
                      ...
                      search: {
                        ...
                        fixed: Object.keys(t.searchFixed).map(function (e) {
                          return {
                            name: e,
                            term:
                              "function" != typeof t.searchFixed[e]
                                ? t.searchFixed[e].toString()
                                : "function",
                          };
                        }),
                      },
              ...
              function (e) {
                var t = l,
                  n = je(t, (e = e)),
                  r = Re(t, "draw", e),
                  a = Re(t, "recordsTotal", e),
                  e = Re(t, "recordsFiltered", e);
                if (void 0 !== r) {
                  if (+r < t.iDraw) return;
                  t.iDraw = +r;
                }
      ...
      if (0 !== o.length)
        for (var d = a ? e.aoData.length : s, f = a ? 0 : i; f < d; f++) {
          ...
          if (null !== p) {
            null === p.nTr && Se(e, h);
            for (var g = p.nTr, m = 0; m < u.length; m++) {
              var v = u[m],
                b = p.anCells[m];
              (y(b, C.type.className[v.sType]), y(b, e.oClasses.tbody.cell));
            }
            (Z(e, "aoRowCallback", null, [g, p._aData, r, f, h]),
              n.push(g),
              r++);
          }
        }
      else n[0] = Ae(e);
      (Z(e, "aoHeaderCallback", "header", [
  ...
  function Ie(e, t, n) {
    ...
    ((void 0 !== n && !0 !== n) ||
      (ue(e),
      a && Qe(e),
      r ? Pe(e, e.oPreviousSearch) : (e.aiDisplay = e.aiDisplayMaster.slice())),
      !0 !== t ? (e._iDisplayStart = 0) : at(e),
      (e._drawHold = t),
      x(e),
  ...
  function Ae(e) {
    ...
    return (
      ("ssp" !== r && "ajax" !== r) || e.json
        ...
        : (n = t.sLoadingRecords),
      H("<tr/>").append(
        H("<td />", { colSpan: ie(e), class: e.oClasses.empty.row }).html(n),
      )[0]
    );
  }
  function Le(e, t, a) {
  ...
  function Ne(t) {
    ...
    if (((t.nTableWrapper = r[0]), t.sDom))
          ...
          "<" == (o = f[h])
            ? ((i = H("<div/>")),
              ("'" != (l = f[h + 1])[0] && '"' != l[0]) ||
                ...
                (s = ""),
                -1 != l.indexOf(".")
                  ? ((u = l.split(".")), (s = u[0]), (u = u[1]))
                  : "#" == l[0]
                    ? (s = l)
                    : (u = l),
                i.attr("id", s.substring(1)).addClass(u),
                h++),
              d.append(i),
              (d = i))
            : ">" == o
      ...
      (n.forEach(function (e) {
        ...
        p(t, r, { full: { table: !0, contents: [Ue(t)] } }),
        e.forEach(function (e) {
          p(t, r, e);
        }));
    }
    ...
    n.oFeatures.bProcessing &&
      ...
      m ? g.prependTo(H("div.dt-scroll", n.nTableWrapper)) : g.insertBefore(e),
      ...
      for (a = (r = c[p]).firstChild; a; ) {
        if (
          ...
          var m,
            ...
            S = H(a);
          for (
            y = (y = +a.getAttribute("colspan")) && 0 != y && 1 != y ? y : 1,
              D = (D = +a.getAttribute("rowspan")) && 0 != D && 1 != D ? D : 1,
              l = ((e, t, n) => {
                for (var r = e[t]; r[n]; ) n++;
                return n;
              })(h, p, 0),
              ...
              n &&
                (s &&
                  ...
                  (b = a.style.width.match(/width:\s*(\d+[pxem%]+)/)) &&
                    (v = b[1]),
                  ...
                  f
                    ? (null === m.sTitle ||
                      ...
                      !m.sTitle &&
                        s &&
                        ((m.sTitle = I(a.innerHTML)), (m.autoTitle = !0)))
                    : m.footer && (a.innerHTML = m.footer),
                  m.ariaTitle ||
                    (m.ariaTitle = S.attr("aria-label") || m.sTitle),
                  m.className) &&
                  S.addClass(m.className),
                0 === H(".dt-column-title", a).length &&
                  H(_.createElement(e.columnTitleTag))
                    .addClass("dt-column-title")
                    .append(a.childNodes)
                    .appendTo(a),
                e.orderIndicators &&
                  f &&
                  0 !== S.filter(":not([data-dt-order=disable])").length &&
                  0 !== S.parent(":not([data-dt-order=disable])").length &&
                  0 === H(".dt-column-order", a).length &&
                  H(_.createElement(e.columnTitleTag))
                    .addClass("dt-column-order")
                    .appendTo(a),
                0 ===
                  H("div.dt-column-" + (b = f ? "header" : "footer"), a)
                    .length) &&
                H("<div>")
            ...
            for (o = 0; o < D; o++)
              ((h[p + o][l + i] = { cell: a, unique: s }), (h[p + o].row = r));
            x.push(l + i);
          }
          a.setAttribute("data-dt-column", w(x).join(","));
        }
        a = a.nextSibling;
      }
    return h;
  ...
  function Oe(n, e, r) {
    function t(e) {
      ...
      ((n.json = e), Z(n, null, "xhr", [n, e, n.jqXHR], !0), r(e));
    }
    var a,
      o = n.ajax,
      i = n.oInstance,
      l =
          ...
          delete o.data),
        {
          ...
          error: function (e, t) {
            (-1 === Z(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(!0) &&
              ("parsererror" == t
    ...
    (H.isPlainObject(o) && H.extend(l, o),
      (n.oAjaxData = e),
      Z(n, null, "preXhr", [n, e, l], !0),
      "json" === l.submitAs &&
        "object" == typeof e &&
        ((l.data = JSON.stringify(e)),
        l.contentType || (l.contentType = "application/json; charset=utf-8")),
      "function" == typeof o
  ...
  function Pe(n, e) {
        ...
        if (c[d] && !(l = c[d])._aFilterData) {
          for (o = [], r = 0, a = u.length; r < a; r++)
            (u[r].bSearchable
              ...
              i.indexOf &&
                -1 !== i.indexOf("&") &&
                ((Me.innerHTML = i), (i = He ? Me.textContent : Me.innerText)),
              i.replace && (i = i.replace(/[\r\n\u2028]/g, "")),
              o.push(i));
          ((l._aFilterData = o), (l._sFilterRow = o.join("  ")), 0);
        }
      ((n.aiDisplay = n.aiDisplayMaster.slice()),
        Ee(n.aiDisplay, n, e.search, e),
        H.each(n.searchFixed, function (e, t) {
          Ee(n.aiDisplay, n, t, {});
        }));
      for (var f = 0; f < t.length; f++) {
        var h = t[f];
        (Ee(n.aiDisplay, n, h.search, h, f),
          H.each(n.aoColumns[f].searchFixed, function (e, t) {
            Ee(n.aiDisplay, n, t, {}, f);
          }));
      }
      for (
        var p, g, m = n, v = V.ext.search, b = m.aiDisplay, y = 0, D = v.length;
        y < D;
        y++
      ) {
    ...
    ((n.bFiltered = !0), Z(n, null, "search", [n]));
  }
  ...
  var ke = V.util.escapeRegex,
    Me = H("<div>")[0],
    He = void 0 !== Me.textContent;
  function We(i) {
    var l,
      t,
      n,
    ...
    i.bInitialised
      ? (Te(i, "header"),
        Te(i, "footer"),
        (n = function () {
          (Ce(i, i.aoHeader), Ce(i, i.aoFooter));
          var n = i.iInitDisplayStart;
          if (s.aaData) for (l = 0; l < s.aaData.length; l++) D(i, s.aaData[l]);
          else (!u && "dom" != c) || he(i, H(i.nTBody).children("tr"));
          ((i.aiDisplay = i.aiDisplayMaster.slice()), Ne(i));
          var e = i,
            t = e.nTHead,
            ...
            ("ssp" == c && !u) ||
              ("ajax" == c
                ? Oe(i, {}, function (e) {
                    ...
                    ((i.iInitDisplayStart = n), Ie(i), S(i, !1), Xe(i));
                  })
                : (Xe(i), S(i, !1))));
        }),
  ...
  function Xe(e) {
    ...
    e._bInitComplete ||
      ((t = [e, e.json]),
      0 === (n = H(e.tfoot)).children().length && n.remove(),
      (e._bInitComplete = !0),
      re(e),
      Z(e, null, "plugin-init", t, !0),
      Z(e, "aoInitComplete", "init", t, !0));
  }
  function Ve(e, t) {
    t = parseInt(t, 10);
    ((e._iDisplayLength = t), at(e), Z(e, null, "length", [e, t]));
  }
  function Be(e, t, n) {
    ...
    ((e._iDisplayStart = r),
      Z(e, null, o ? "page" : "page-nc", [e]),
      o && n && x(e));
  }
  function S(e, t) {
    (e.bDrawing && !1 === t) || Z(e, null, "processing", [e, t]);
  }
  function qe(e, t, n) {
    t
      ? (S(e, !0),
  ...
  function ze(t) {
    ...
    if (t.scrollBarVis !== h && void 0 !== t.scrollBarVis)
      ...
      if (
        ...
        for (
          var p = null, g = "ssp" !== G(t) ? t._iDisplayStart : 0, m = g;
        ...
        if (p)
          for (
            var b = H(p)
                .children("th, td")
                .map(function (e) {
                  return { idx: ae(t, e), width: H(this).outerWidth() };
                }),
              m = 0;
            m < b.length;
            m++
      ...
      var u =
        ...
        D = c.outerWidth();
      (a.css("width", A(D)),
        r.css("width", A(D)).css(h, u ? n + "px" : "0px"),
        d &&
          (s.css("width", A(D)),
          l.css("width", A(D)).css(h, u ? n + "px" : "0px")),
        c.children("colgroup").prependTo(c),
        c.find("thead, tfoot").find("[tabindex]").removeAttr("tabindex"),
        c.find("thead, tfoot").find("role").removeAttr("role"),
        i.trigger("scroll"),
  ...
  function Ze(o, e, t, i, l) {
    rt(e, t, function (e) {
      ...
      if (n.length) {
        ...
        t &&
          qe(o, !0, function () {
            (Qe(o), Ge(o, o.aiDisplay), Ie(o, !1, !1), l && l());
          });
      }
    });
  }
  ...
  function Qe(e, t, n) {
    ...
    for (
      ...
      b && (u = b.call(g.oInstance, g, m, oe(g, m)));
      for (
    ...
    return (
      void 0 === t &&
        ((e.bSorted = !0), (e.sortDetails = c), Z(e, null, "order", [e, c])),
      s
    );
  }
  function Ke(e) {
  ...
  function et(n) {
    ...
    n._bLoadingState ||
      ...
      (n.oSavedState = e),
      Z(n, "aoStateSaveParams", "stateSaveParams", [n, e]),
  ...
  function tt(r, e, t) {
    ...
    if (e && e.time) {
      ...
      if (0 < s && e.time < +new Date() - 1e3 * s) r._bLoadingState = !1;
        ...
        ((r._bLoadingState = !1), Z(r, "aoStateLoaded", "stateLoaded", [r, e]));
      }
  ...
  function z(e, t, n, r) {
    if (
      ...
      if ((e && Z(e, null, "dt-error", [e, r, n], !0), "alert" == t)) alert(n);
      else {
  ...
  ((X = function (e, t) {
    ...
    ((this.context = 1 < o.length ? w(o) : o),
      lt(this, t),
      (this.selector = { rows: null, cols: null, opts: null }),
      X.extend(this, this, ct));
  }),
    (V.Api = X),
    H.extend(X.prototype, {
      ...
      unique: function () {
        return new X(this.context, w(this.toArray()));
      },
      unshift: t.unshift,
    }),
    (W.__apiStruct = ct),
    ...
    (X.register = r =
      function (e, t) {
        if (Array.isArray(e))
          ...
          for (var a = e.split("."), o = ct, i = 0, l = a.length; i < l; i++) {
            var s,
              u,
              c = ((e, t) => {
                for (var n = 0, r = e.length; n < r; n++)
    ...
    (e &&
      ...
      "ssp" == G(a)
        ...
        : (S(a, !0),
          ...
          Oe(a, {}, function (e) {
            be(a);
            for (var t = je(a, e), n = 0, r = t.length; n < r; n++) D(a, t[n]);
            (Ie(a, o), Xe(a), S(a, !1));
          })));
  }
  ...
  (r("tables()", function (e) {
    return null != e ? new X(dt(e, this.context)) : this;
  }),
    r("table()", function (e) {
      var e = this.tables(e),
        t = e.context;
    ...
    r("draw()", function (t) {
      return this.iterator("table", function (e) {
        "page" === t
          ? x(e)
          : Ie(e, !1 === (t = "string" == typeof t ? "full-hold" !== t : t));
      });
    }),
    r("page()", function (t) {
      return void 0 === t
      ...
      if (Array.isArray(e) || e instanceof H)
        ...
        e.nodeName && "tr" === e.nodeName.toLowerCase()
          ...
          : ((n = H("<tr><td></td></tr>")
              ...
              .addClass(t)),
            (H("td", n).addClass(t).html(e)[0].colSpan = ie(o)),
            s.push(n[0]));
    }
    var s = [];
    (l(e, t),
  ...
  function vt(e, t) {
    ...
    r.length &&
      e.length &&
      (n = r[0].aoData[e[0]])._details &&
      ((n._detailsShow = t)
        ? (n._details.insertAfter(n.nTr), H(n.nTr).addClass("dt-hasChild"))
        : (n._details.detach(), H(n.nTr).removeClass("dt-hasChild")),
      Z(r[0], null, "childRow", [t, e.row(e[0])]),
      (i = r[0]),
      (a = new X(i)),
      (t = "draw" + (n = ".dt.DT_details")),
      (e = "column-sizing" + n),
      (n = "destroy" + n),
      (l = i.aoData),
      a.off(t + " " + e + " " + n),
      0 < b(l, "_details").length &&
        (a.on(t, function (e, t) {
          i === t &&
            a
              .rows({ page: "current" })
        ...
        a.on(e, function (e, t) {
          if (i === t)
            for (var n, r = ie(t), a = 0, o = l.length; a < o; a++)
              (n = l[a]) &&
                n._details &&
                n._details.each(function () {
                  var e = H(this).children("td");
                  1 == e.length && e.attr("colspan", r);
                });
        }),
        a.on(n, function (e, t) {
          if (i === t)
            for (var n = 0, r = l.length; n < r; n++)
              l[n] && l[n]._details && Ct(a, n);
        })),
      _t(r));
  }
  ...
  function yt(e, t, n) {
    ...
    if (void 0 !== n) a = n;
      ...
      for (var o = 0; o < r.length; o++)
        r[o][t].unique && H(".dt-column-title", r[o][t].cell).text() && (a = o);
      null === a && (a = 0);
    }
    return r[a][t].cell;
  }
  function Dt(i, e, l) {
        ...
        function (n) {
          ...
          if ("function" == typeof n)
            return (
              (r = wt(i, l)),
              c.map(function (e, t) {
                return n(t, bt(i, t, 0, 0, r), yt(i, t)) ? t : null;
              })
            );
          var t,
            a,
            o = "string" == typeof n ? n.match(Lt) : "";
          if (o)
            switch (o[2]) {
              case "visIdx":
              case "visible":
              ...
              case "name":
                return (s = s || b(c, "sName")).map(function (e, t) {
                  return e === o[1] ? t : null;
                });
              case "title":
                return (u = u || b(c, "sTitle")).map(function (e, t) {
                  return e === o[1] ? t : null;
                });
              default:
                return [];
    ...
    return l.columnOrder && "index" === l.columnOrder
      ? e.sort(function (e, t) {
          return e - t;
        })
      : e;
  ...
  var xt,
    ...
    wt = function (e, t) {
      var n,
        ...
        l = t.order,
        t = t.page;
      if ("ssp" == G(e)) return "removed" === i ? [] : h(0, o.length);
      if ("current" == t)
    ...
    Tt =
            ...
            return (
              (t = ht(
                ...
                function (n) {
                  ...
                  if (((i = i || wt(a, o)), null !== e && -1 !== i.indexOf(e)))
                    return [e];
              ...
              ("current" !== o.order && "applied" !== o.order) || Ge(a, t),
              t
            );
            var a, t, o, i;
          },
      ...
      r("rows.add()", function (o) {
        var e = this.iterator(
          ...
          t = this.rows(-1);
        return (t.pop(), lt(t, e), t);
      }),
      r("row()", function (e, t) {
        return gt(this.rows(e, t));
      }),
      ...
      function (e, t) {
        t &&
          ...
          e
            ...
            .every(function () {
              Z(e.settings()[0], null, "requestChild", [this]);
            });
      }),
    _t = V.util.throttle(function (e) {
      et(e[0]);
    }, 500),
    Ct = function (e, t) {
      var n = e.context;
        ...
        return void 0 === e
          ...
          : (!0 === e
              ...
              : !1 === e
                ...
                : n.length &&
                  this.length &&
                  mt(n[0], n[0].aoData[this[0]], e, t),
            this);
      }),
      r([It + ".show()", At + ".show()"], function () {
        return (vt(this, !0), this);
      }),
      r([It + ".hide()", At + ".hide()"], function () {
        return (vt(this, !1), this);
      }),
      r([It + ".remove()", At + ".remove()"], function () {
        return (Ct(this), this);
      }),
      r(It + ".isShown()", function () {
        var e = this.context;
        return (
          (e.length &&
            this.length &&
  ...
  (r("columns()", function (t, n) {
    (void 0 === t ? (t = "") : H.isPlainObject(t) && ((n = t), (t = "")),
      (n = pt(n)));
    var e = this.iterator(
      "table",
      function (e) {
    ...
    e("columns().data()", "column().data()", function () {
      return this.iterator("column-rows", bt, 1);
    }),
    e("columns().render()", "column().render()", function (o) {
      return this.iterator(
        "column-rows",
        function (e, t, n, r, a) {
          return bt(e, t, 0, 0, a, o);
        },
        1,
      );
    }),
    ...
    e("columns().titles()", "column().title()", function (n, r) {
      return this.iterator(
        ...
        function (e, t) {
          ...
          t = H(".dt-column-title", this.column(t).header(r));
        ...
        void 0 !== n &&
          this.iterator("table", function (e) {
            (Ce(e, e.aoHeader),
              Ce(e, e.aoFooter),
              e.aiDisplay.length ||
                H(e.nTBody).find("td[colspan]").attr("colspan", ie(e)),
              et(e),
              t.iterator("column", function (e, t) {
                a.includes(t) && Z(e, null, "column-visibility", [e, t, n, r]);
              }),
    ...
    r("column()", function (e, t) {
      return gt(this.columns(e, t));
    }));
  function Nt(e, t) {
    (H(e).find(".dt-column-order").remove(),
      H(e)
  ...
  (r("cells()", function (g, e, m) {
    ...
    e("cells().indexes()", "cell().index()", function () {
      return this.iterator(
        "cell",
        function (e, t, n) {
          return { row: t, column: n, columnVisible: oe(e, n) };
        },
        1,
      );
    }),
    ...
    r("cell().data()", function (e) {
      ...
      return void 0 === e
        ...
        : ((t = i[0]),
          ...
          ye(i[0], l[0].row, "data", l[0].column),
          this);
    }),
    r("order()", function (n, e) {
      ...
      return void 0 === n
        ? 0 !== t.length
          ? t[0].aaSorting
          : void 0
        : ("number" == typeof n ? (n = [[n, e]]) : 1 < r.length && (n = r),
          this.iterator("table", function (e) {
            var t = [];
    ...
    e("columns().search()", "column().search()", function (r, a, o, i) {
      return this.iterator("column", function (e, t) {
        ...
        e.oFeatures.bFilter &&
          ...
          Pe(e, e.oPreviousSearch));
      });
    }),
    r(["columns().search.fixed()", "column().search.fixed()"], function (n, r) {
      ...
      if (void 0 === n && "string" == typeof t)
        switch (t) {
          ...
          case "moment":
            return i;
          case "bootstrap":
            return xt || W.bootstrap;
          case "foundation":
            return St || W.Foundation;
          default:
            return null;
        }
            ...
            : "luxon" === t || (n && n.FixedOffsetZone)
              ...
              : "moment" === t || (n && n.isMoment)
                ...
                : "bootstrap" === t ||
                  ...
                  ? (xt = n)
                  : ("foundation" === t || (n && n.Reveal)) && (St = n);
    }),
    (V.factory = function (e, t) {
      var n = !1;
      return (
        e && e.document && (_ = (W = e).document),
      ...
      return (
        ...
        this.iterator("table", function (e) {
          var t = e.oClasses,
            ...
            o =
              ((e.bDestroying = !0),
              Z(e, "aoDestroyCallback", "destroy", [e], !0),
              ...
              n != a.parentNode && (i.children("thead").detach(), i.append(a)),
              o &&
                n != o.parentNode &&
  ...
  function Ft(t, n) {
    return function (e) {
      return (
        T(e) ||
          "string" != typeof e ||
          ((e = e.replace(F, " ")), t && (e = I(e)), n && (e = M(e, !1))),
        e
      );
    };
  }
  ...
  var o,
    i,
    jt = !1,
    Rt = /[T\s]\d{2}.*?(Z|[+-]\d{2}(?::?\d{2})?)$/;
  function Pt(e, t, n) {
    var r;
    if ((W.luxon && !o && (o = W.luxon), (i = W.moment && !i ? W.moment : i))) {
      if (!(r = i(e, t, n, !0)).isValid()) return null;
    } else if (o) {
      if (
        !(r =
          t && "string" == typeof e
  ...
  function Et(u) {
    return function (a, o, i, l) {
      0 === arguments.length
        ? ((i = "en"), (a = o = null))
        : 1 === arguments.length
          ? ((i = "en"), (o = a), (a = null))
          : 2 === arguments.length && ((i = o), (o = a), (a = null));
      var s = "datetime" + (o ? "-" + o : "");
      return (
        V.ext.type.order[s + "-pre"] ||
          V.type(s, {
            detect: function (e) {
              return e === s && s;
            },
            ...
            "type" === t
              ...
              : "" === e
                ...
                : !(
                    ...
                    ((n = {}),
                    (r = "string" == typeof e ? e.match(Rt) : null) &&
                      (n.timeZone = "Z" === r[1] ? "UTC" : r[1]),
                    null === (r = Pt(e, a, i)))
                  ? e
                  : "sort" === t
                    ? r
                    : ((e =
                        null === o
                          ? Ot(r, "toDate", "toJSDate", "")[u](
                              navigator.language,
                              n,
                            )
                          : Ot(r, "format", "toFormat", "toISOString", o)),
                      "display" === t ? c(e) : e)
          );
        }
      );
  ...
  if (void 0 !== W.Intl)
    try {
      for (
        var Ht = new Intl.NumberFormat().formatToParts(100000.1), l = 0;
        l < Ht.length;
        l++
      )
        "group" === Ht[l].type
          ? (kt = Ht[l].value)
          : "decimal" === Ht[l].type && (Mt = Ht[l].value);
    } catch (e) {}
  ...
  var s = V.ext.type,
    Vt =
      ...
      V.type("html", {
        ...
        order: {
          pre: function (e) {
            return T(e) ? "" : e.replace ? I(e).trim().toLowerCase() : e + "";
          },
        },
        search: Ft(!0, !0),
      }),
      ...
      V.type("date", {
        ...
        detect: {
          allOf: function (e) {
            var t;
            return !e || e instanceof Date || R.test(e)
              ? (null !== (t = Date.parse(e)) && !isNaN(t)) || T(e)
              : null;
          },
          oneOf: function (e) {
  ...
  (H.extend(!0, V.ext.renderer, {
          ...
          H(g.nTable).on(
            ...
            function (e, t, n) {
              if (g === t) {
                ...
                if (r) {
                  var a = b(r, "col");
                  if ("column-visibility" !== e.type || a.includes(n)) {
                    for (
                      var e = v.order,
                        n = t.api.columns(m),
                        ...
                        f =
                          (m
                            .removeClass(e.isAsc + " " + e.isDesc)
                            .toggleClass(e.none, !i)
                            .toggleClass(e.canAsc, d && u.includes("asc"))
                            .toggleClass(e.canDesc, d && u.includes("desc")),
                          !0),
                        h = 0;
                      h < s.length;
                      h++
                    ...
                    (s[0] == p
                      ? ((u = r[0]),
                        ...
                        (l = n[u.index + 1] ? "Reverse" : "Remove"))
                      : m.removeAttr("aria-sort"),
                      i &&
                        ((d = m.find(".dt-column-order"))
                          .attr("role", "button")
                          .attr(
                            "aria-label",
                            i
    ...
    (V.feature.register = function (e, t, n) {
      ((V.ext.features[e] = t),
        n && C.feature.push({ cFeature: n, fnInit: t }));
    }),
    V.feature.register("div", function (e, t) {
      var n = H("<div>")[0];
      return (
        t &&
          (Bt(n, "className", t.className),
          Bt(n, "id", t.id),
          Bt(n, "innerHTML", t.html),
          Bt(n, "textContent", t.text)),
        n
      );
    }),
    V.feature.register(
      ...
      return n.oFeatures.bFilter
        ? ((e = n.oClasses.search),
          ...
          -1 ===
            (r = H.extend(
              {
                placeholder: (c = n.oLanguage).sSearchPlaceholder,
                processing: !1,
                text: c.sSearch,
              },
              r,
          ...
          (s = H("<div>")
            ...
            .find("label")
            .attr("for", "dt-search-" + qt),
          s.find("input").attr("id", "dt-search-" + qt),
          qt++,
          (u = function (e) {
            var t = this.value;
            (a.return && "Enter" !== e.key) ||
              (t != a.search &&
                qe(n, r.processing, function () {
                  ((a.search = t), Pe(n, a), (n._iDisplayStart = 0), x(n));
                }));
          }),
      ...
      function (e, t) {
        ...
        function n() {
          !(function e(t, n, r) {
            ...
            var a = r.type ? V.ext.pager[r.type] : Ut,
              ...
              i = a(r).map(function (e) {
                return "numbers" === e
                  ? $t(c, d, r.buttons, r.boundaryNumbers)
                  : e;
              });
            ...
            for (var p = 0; p < f.length; p++) {
              ...
              (H(v.clicker).attr({
                ...
                tabIndex: m.disabled
                  ? -1
                  : t.iTabIndex &&
                      "span" !== v.clicker[0].nodeName.toLowerCase()
                    ? t.iTabIndex
                    : null,
              }),
                "number" != typeof g && H(v.clicker).addClass(g),
                rt(v.clicker, { action: g }, function (e) {
                  (e.preventDefault(), Be(t, e.data.action, !0));
                }),
                h.push(v.display));
            }
            u = ot(t, "pagingContainer")(t, h);
    ...
    V.feature.register(
      ...
      function (r, e) {
        ...
        for (
            ...
            f =
              ...
              function (t) {
                d.forEach(function (e) {
                  e.el.textContent = it(r, e.text, t);
                });
              }),
          ...
          (null === g &&
            (g = "number" == typeof i[p] ? r.fnFormatNumber(i[p]) : i[p]),
            (h[0][p] = new Option(g, o[p])));
        }
        return (
          c.find("label").attr("for", "dt-length-" + Yt),
          h.attr("id", "dt-length-" + Yt),
          Yt++,
